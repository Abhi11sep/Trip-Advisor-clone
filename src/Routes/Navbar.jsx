  ...
  return (
    <div id="navbar">
      <div className="nav-left">
        <Link to="/">
          <img src={img1} alt="Voyage Guide" className="logo" />
        </Link>
      </div>

      <div className="nav-right">
        <Button onClick={onOpen} className="signin-btn">
          <AccountCircleOutlined />
          <span>{isLoad1 && isLoad2 && isLoad3 ? "Sign In" : "Welcome"}</span>
        </Button>
        ...
        >
          ...
          <ModalContent className="login-modal">
            ...
            <img src={img1} alt="logo" className="modal-logo" />

            <ModalHeader className="modal-title">
              Welcome to Voyage Guide
            </ModalHeader>

            <p className="modal-subtitle">
              Discover restaurants, hotels and attractions around the world.
            </p>
            ...
            <ModalFooter className="modal-footer">
              By continuing, you agree to our Terms of Use, Privacy Policy and Cookie Policy.
            </ModalFooter>
    ...
    // <div id='navbar'>
    //   <Link to='/'><img src={img1} alt='picasa' width='100px' /></Link>
    //   <div>
    //     <Button onClick={onOpen} style={{
    //       textDecoration: "none", backgroundColor: '#b5b5fd', color: "#051D40",
    //       fontSize: "18px", borderRadius: "25px", marginTop: "15px", marginLeft: '35px', marginRight: '35px', paddingLeft: "25px",
    //       paddingRight: "25px", paddingTop: '5px', paddingBottom: '5px', border: 'none'
